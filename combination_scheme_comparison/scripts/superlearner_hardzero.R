...
#' Predictor matrix fed to MICE: the 10 standard features PLUS the 4 hard-zero
#' domain columns (Alpha_opt/Beta_opt/log10Fa_opt/log10Ta_opt -- real native-
#' optical value for optical-only GRBs, structural 0 for X-ray-native GRBs;
#' never missing, so MICE passes them through unchanged), independent of the
