...
#            'SL.glm', 'SL.glm.interaction', 'SL.glmnet','SL.ipredbagg', #'SL.ksvm', #probably the line that errors out
...
par(mar=c(5, 10, 4, 2))
png(filename = 'model_compare_plot.png',res=700,width=3000,height=3000)
