...
{ ##### BOX PLOT ####
  png(filename = paste(PLOTaddr,'BoxPlotOfRedshift',plotnames,'.png',sep = ''),width = (750*sz),height = (750*sz),res=rez)
...
{ ##### BOX PLOT ####
  png(filename = paste(PLOTaddr,'BoxPlotOfNormalizedRedshift',plotnames,'.png',sep = ''),width = (750*sz),height = (750*sz),res=rez)
