...
GRBPred <- subset(GRBPred, select = !colnames(GRBPred) %in% c("Redshift_crosscheck", "invz","X"))
...
GRBPred$Response = GRBPred$log10z
...
rownames(GRBPred[M_est$w < weight_threshold, ])
