...
# Physically-impossible values: null out the offending column and let MICE
# re-impute it rather than dropping the GRB (matches spencer's convention --
# Beta cutoff kept at 2 per earlier correction, mechanism reverted to NA+impute).
