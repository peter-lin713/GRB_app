...
if(run_locally){
  ...
  # ABLATION: log10Fa, log10Ta, Alpha, Beta removed entirely below to test
  # their marginal contribution to the winning formula search.
} else {
...
.outliers <- update_nonnegotiable_outliers(raw_xray_data, out_dir = ".", method = "no_plateau")
...
features_for_mice_errs = raw_xray_data[, c("T90Err", fluence_err_col,
