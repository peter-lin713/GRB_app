...
if(run_locally){
  raw_xray_data <- read.csv("superlearner_training_theilsen_reversed_xray_to_opt.csv", header = TRUE, row.names = 1)
} else {
...
.outliers <- update_nonnegotiable_outliers(raw_xray_data, out_dir = ".", method = "theilsen_reversed")
